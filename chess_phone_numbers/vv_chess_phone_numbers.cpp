...
{
  if (g_trace && !prompt.empty())
    cout << prompt << endl;
  string result;
  getline(cin, result);
  if (g_trace)
    cout << "Input consumed was: " << result << endl;
  return result;
}
...
int main(int argc, char **argv)
{
  ...
  if (g_trace)
    cout << "RESULT: Num valid phone numbers is: " << endl;
